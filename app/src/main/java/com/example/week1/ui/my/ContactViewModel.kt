...
class ContactViewModel: ViewModel() {
    private val _contactList= MutableLiveData<List<Contact>>(
        listOf(
            ...
            //대구
            Contact("땅땅치킨","영업시간 9:00-19:00","053-2422-1234",R.drawable.samsung1,isFavorite=false,stadium="대구삼성라이온즈파크", recommendedMenu = listOf("소시지","또띠아")),
            Contact("5직떡볶이","영업시간 9:00-19:00","053-2422-1234",R.drawable.samsung2,isFavorite=false,stadium="대구삼성라이온즈파크", recommendedMenu = listOf("소시지","또띠아")),
            Contact("한만두","영업시간 9:00-19:00","053-2422-1234",R.drawable.samsung3,isFavorite=false,stadium="대구삼성라이온즈파크", recommendedMenu = listOf("갈비만두","짬뽕만두")),
            Contact("족발슈퍼","영업시간 9:00-19:00","053-2422-1234",R.drawable.samsung4,isFavorite=false,stadium="대구삼성라이온즈파크", recommendedMenu = listOf("순살족발","소떡소떡")),
            Contact("블루팡팡","영업시간 9:00-19:00","053-2422-1234",R.drawable.samsung5,isFavorite=false,stadium="대구삼성라이온즈파크", recommendedMenu = listOf("구슬아이스크림")),
            Contact("전설꼬치","영업시간 9:00-19:00","053-2422-1234",R.drawable.samsung6,isFavorite=false,stadium="대구삼성라이온즈파크", recommendedMenu = listOf("닭살꼬치","파닭꼬치")),
            //고척
            Contact("감탄계","영업시간 9:00-19:00","02-2422-1234",R.drawable.ki1,isFavorite=false,stadium="고척스카이돔", recommendedMenu = listOf("숯불양념구이")),
            Contact("감자아이스크림","영업시간 9:00-19:00","02-2422-1234",R.drawable.ki2,isFavorite=false,stadium="고척스카이돔", recommendedMenu = listOf("감자아이스크림")),
            Contact("오토김밥","영업시간 9:00-19:00","02-2422-1234",R.drawable.ki3,isFavorite=false,stadium="고척스카이돔", recommendedMenu = listOf("오토김밥","오토 닭강정 콤비")),
            Contact("백남옥손만두","영업시간 9:00-19:00","02-2422-1234",R.drawable.ki4,isFavorite=false,stadium="고척스카이돔", recommendedMenu = listOf("고기통만두","김치통만두")),
            Contact("쉬림프쉐프","영업시간 9:00-19:00","02-2422-1234",R.drawable.ki5,isFavorite=false,stadium="고척스카이돔", recommendedMenu = listOf("소시지","또띠아")),
            //NC
            Contact("제일버거","영업시간 9:00-19:00","055-2422-1234",R.drawable.nc1,isFavorite=false,stadium="창원NC파크", recommendedMenu = listOf("제일버거, NC다이노소세지")),
            Contact("싸움의고수","영업시간 9:00-19:00","055-2422-1234",R.drawable.nc2,isFavorite=false,stadium="창원NC파크", recommendedMenu = listOf("싸움족발","마늘족발")),
            Contact("알통 떡강정","영업시간 9:00-19:00","055-2422-1234",R.drawable.nc3,isFavorite=false,stadium="창원NC파크", recommendedMenu = listOf("알통떡강정")),
            Contact("죠스떡볶이","영업시간 9:00-19:00","055-2422-1234",R.drawable.nc4,isFavorite=false,stadium="창원NC파크", recommendedMenu = listOf("떡볶이","수제튀김")),
            Contact("리얼피그","영업시간 9:00-19:00","055-2422-1234",R.drawable.nc5,isFavorite=false,stadium="창원NC파크", recommendedMenu = listOf("NC대세닭")),
            Contact("스트릿츄러스","영업시간 9:00-19:00","055-2422-1234",R.drawable.nc6,isFavorite=false,stadium="창원NC파크", recommendedMenu = listOf("아이스크림츄로볼")),
            //광주
            Contact("인크커피","영업시간 9:00-19:00","055-2422-1234",R.drawable.kia1,isFavorite=false,stadium="광주기아챔피언스필드", recommendedMenu = listOf("불고기독","미트칠리독")),
            Contact("양동시장 치킨","영업시간 9:00-19:00","055-2422-1234",R.drawable.kia2,isFavorite=false,stadium="광주기아챔피언스필드", recommendedMenu = listOf("후라이드닭강정")),
            Contact("스테이션","영업시간 9:00-19:00","055-2422-1234",R.drawable.kia3,isFavorite=false,stadium="광주기아챔피언스필드", recommendedMenu = listOf("크림새우")),
            Contact("짝태패밀리","영업시간 9:00-19:00","055-2422-1234",R.drawable.kia4,isFavorite=false,stadium="광주기아챔피언스필드", recommendedMenu = listOf("오징어")),
            Contact("시골집","영업시간 9:00-19:00","055-2422-1234",R.drawable.kia5,isFavorite=false,stadium="광주기아챔피언스필드", recommendedMenu = listOf("애호박찌개")),
