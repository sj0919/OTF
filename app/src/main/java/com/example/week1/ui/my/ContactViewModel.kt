...
class ContactViewModel: ViewModel() {
    private val _contactList= MutableLiveData<List<Contact>>(
        listOf(
            ...
            Contact("광천식당","영업시간 9:00-19:00","042-2422-1234",R.drawable.hanwha8,isFavorite=false,stadium="한화이글스파크", recommendedMenu = listOf("매운닭강정","순한닭강정")),
            Contact("야구장왕돈까스","영업시간 9:00-19:00","042-2422-1234",R.drawable.hanwha9,isFavorite=false,stadium="한화이글스파크", recommendedMenu = listOf("왕돈까스")),
            Contact("오늘은족발","영업시간 9:00-19:00","042-2422-1234",R.drawable.hanwha10,isFavorite=false,stadium="한화이글스파크", recommendedMenu = listOf("족발","매운족발")),
            Contact("홈런친닭","영업시간 9:00-19:00","042-2422-1234",R.drawable.hanwha11,isFavorite=false,stadium="한화이글스파크", recommendedMenu = listOf("새우강정","닭강정")),
            //잠실
