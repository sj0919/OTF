...
class ContactViewModel: ViewModel() {
    private val _contactList= MutableLiveData<List<Contact>>(
        listOf(
            ...
            //사직
            Contact("소문난 주문진 막국수 부산","9:00-19:00","051-2422-1234",R.drawable.busan1,isFavorite=false,stadium="사직야구장", recommendedMenu = listOf("막국수", "수육")),
            Contact("쌍둥이 돼지국밥 부산","9:00-19:00","051-2422-1234",R.drawable.busan2,isFavorite=false,stadium="사직야구장", recommendedMenu = listOf("돼지국밥","순대국밥")),
            Contact("33떡볶이","9:00-19:00","051-2422-1234",R.drawable.busan3,isFavorite=false,stadium="사직야구장", recommendedMenu = listOf("떡볶이","꼬마김밥","33세트")),
            Contact("남도푸드앤","9:00-19:00","051-2422-1234",R.drawable.busan4,isFavorite=false,stadium="사직야구장", recommendedMenu = listOf("버터먹태","거인의 세트")),
            Contact("정직유부초밥","9:00-19:00","051-2422-1234",R.drawable.busan5,isFavorite=false,stadium="사직야구장", recommendedMenu = listOf("정직유부,참치마요유부")),
            Contact("닭터케이 닭꼬치","9:00-19:00","051-2422-1234",R.drawable.busan6,isFavorite=false,stadium="사직야구장", recommendedMenu = listOf("그냥닭","양념닭")),
            //문학
            Contact("스테이션","9:00-19:00","032-2422-1234",R.drawable.ssg1,isFavorite=false,stadium="인천SSG랜더스필드", recommendedMenu = listOf("크림새우")),
            Contact("허갈닭강정","9:00-19:00","032-2422-1234",R.drawable.ssg2,isFavorite=false,stadium="인천SSG랜더스필드", recommendedMenu = listOf("닭강정 허브달콤맛")),
            Contact("북촌손만두","9:00-19:00","032-2422-1234",R.drawable.ssg3,isFavorite=false,stadium="인천SSG랜더스필드", recommendedMenu = listOf("피냉면")),
            Contact("킹콩떡볶이","9:00-19:00","032-2422-1234",R.drawable.ssg4,isFavorite=false,stadium="인천SSG랜더스필드", recommendedMenu = listOf("킹콩국물떡볶이","쿵쿵튀김")),
            Contact("시빌라핫도그","9:00-19:00","032-2422-1234",R.drawable.ssg5,isFavorite=false,stadium="인천SSG랜더스필드", recommendedMenu = listOf("소시지","또띠아")),
            //대구
            Contact("땅땅치킨","9:00-19:00","053-2422-1234",R.drawable.samsung1,isFavorite=false,stadium="대구삼성라이온즈파크", recommendedMenu = listOf("소시지","또띠아")),
            Contact("5직떡볶이","9:00-19:00","053-2422-1234",R.drawable.samsung2,isFavorite=false,stadium="대구삼성라이온즈파크", recommendedMenu = listOf("소시지","또띠아")),
            Contact("한만두","9:00-19:00","053-2422-1234",R.drawable.samsung3,isFavorite=false,stadium="대구삼성라이온즈파크", recommendedMenu = listOf("갈비만두","짬뽕만두")),
            Contact("족발슈퍼","9:00-19:00","053-2422-1234",R.drawable.samsung4,isFavorite=false,stadium="대구삼성라이온즈파크", recommendedMenu = listOf("순살족발","소떡소떡")),
            Contact("블루팡팡","9:00-19:00","053-2422-1234",R.drawable.samsung5,isFavorite=false,stadium="대구삼성라이온즈파크", recommendedMenu = listOf("구슬아이스크림")),
            Contact("전설꼬치","9:00-19:00","053-2422-1234",R.drawable.samsung6,isFavorite=false,stadium="대구삼성라이온즈파크", recommendedMenu = listOf("닭살꼬치","파닭꼬치")),
            //고척
            Contact("감탄계","9:00-19:00","02-2422-1234",R.drawable.ki1,isFavorite=false,stadium="고척스카이돔", recommendedMenu = listOf("숯불양념구이")),
            Contact("감자아이스크림","9:00-19:00","02-2422-1234",R.drawable.ki2,isFavorite=false,stadium="고척스카이돔", recommendedMenu = listOf("감자아이스크림")),
            Contact("오토김밥","9:00-19:00","02-2422-1234",R.drawable.ki3,isFavorite=false,stadium="고척스카이돔", recommendedMenu = listOf("오토김밥","오토 닭강정 콤비")),
            Contact("백남옥손만두","9:00-19:00","02-2422-1234",R.drawable.ki4,isFavorite=false,stadium="고척스카이돔", recommendedMenu = listOf("고기통만두","김치통만두")),
            Contact("쉬림프쉐프","9:00-19:00","02-2422-1234",R.drawable.ki5,isFavorite=false,stadium="고척스카이돔", recommendedMenu = listOf("소시지","또띠아")),
            //NC
            Contact("제일버거","9:00-19:00","055-2422-1234",R.drawable.nc1,isFavorite=false,stadium="창원NC파크", recommendedMenu = listOf("제일버거, NC다이노소세지")),
            Contact("싸움의고수","9:00-19:00","055-2422-1234",R.drawable.nc2,isFavorite=false,stadium="창원NC파크", recommendedMenu = listOf("싸움족발","마늘족발")),
            Contact("알통 떡강정","9:00-19:00","055-2422-1234",R.drawable.nc3,isFavorite=false,stadium="창원NC파크", recommendedMenu = listOf("알통떡강정")),
            Contact("죠스떡볶이","9:00-19:00","055-2422-1234",R.drawable.nc4,isFavorite=false,stadium="창원NC파크", recommendedMenu = listOf("떡볶이","수제튀김")),
            Contact("리얼피그","9:00-19:00","055-2422-1234",R.drawable.nc5,isFavorite=false,stadium="창원NC파크", recommendedMenu = listOf("NC대세닭")),
            Contact("스트릿츄러스","9:00-19:00","055-2422-1234",R.drawable.nc6,isFavorite=false,stadium="창원NC파크", recommendedMenu = listOf("아이스크림츄로볼")),
            //광주
            Contact("인크커피","9:00-19:00","055-2422-1234",R.drawable.kia1,isFavorite=false,stadium="광주기아챔피언스필드", recommendedMenu = listOf("불고기독","미트칠리독")),
            Contact("양동시장 치킨","9:00-19:00","055-2422-1234",R.drawable.kia2,isFavorite=false,stadium="광주기아챔피언스필드", recommendedMenu = listOf("후라이드닭강정")),
            Contact("스테이션","9:00-19:00","055-2422-1234",R.drawable.kia3,isFavorite=false,stadium="광주기아챔피언스필드", recommendedMenu = listOf("크림새우")),
